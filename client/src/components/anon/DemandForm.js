                    ...
                    <div className="card-border  lg:min-w-[566px]">
                        <div className="flex flex-col  gap-6 card py-14 px-10" >
                            <Form className="w-full space-y-6 mt-4 form"{...form}>
                                <form className="w-full  grid gap-10 form" onSubmit={form.handleSubmit(onSubmit)}>
                                    <FormField name="name" control={form.control} label="Name" placeholder="abd allah abd assamad" />
                                    <FormField name="email" control={form.control} label="Email" placeholder="m@example.com" />
                                    <FormField name="address" control={form.control} label="Address" placeholder="Mahdia,Hiboun" />
