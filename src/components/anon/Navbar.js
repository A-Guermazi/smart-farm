...
export default function Navbar() {
    return (
        <div className='hidden lg:flex justify-between shadow-2xs items-center px-5  font-medium z-50 w-full backdrop-blur-sm sticky top-0 bg-white content-center '>


            <Link href="/" className=" hidden lg:flex items-center gap-2 font-bold text-xl text-green-600 ">
